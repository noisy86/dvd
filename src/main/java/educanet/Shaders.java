...
public class Shaders {
    private static final String vertexShaderSource = FileUtils.readFile("shaders/vertex-shader.glsl");

    private static final String fragmentShaderSource = FileUtils.readFile("shaders/fragment-shader.glsl");
